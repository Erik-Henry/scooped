...
<nav class="position-relative site-header sticky-top py-1">
  <div class="container d-flex flex-column flex-md-row justify-content-between">
    ...
    <a class="py-2 d-none d-md-inline-block font-weight-bold" href=".#">Home</a>
    <a class="py-2 d-none d-md-inline-block font-weight-bold" href="drivers">Drivers</a>
